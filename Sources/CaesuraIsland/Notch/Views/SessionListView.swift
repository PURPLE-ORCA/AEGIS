...
final class IconCache {
    ...
    func image(for id: String) -> NSImage? {
        ...
        let candidates: [URL?] = [
            ...
            // Dev fallback: project root Resources dir when running .build/debug/CaesuraIsland
            URL(fileURLWithPath: "\(home)/Projects/caesura-island/Resources/cli-icons/\(id).png"),
        ]

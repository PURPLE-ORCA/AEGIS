...
struct OnboardingView: View {
    ...
    private var hooksStep: some View {
        VStack(spacing: 20) {
            ...
            subtitle("CAESURA-ISLAND installed its hooks for every agent it detected. It's now listening for:")
    ...
    private var readyStep: some View {
        VStack(spacing: 20) {
            ...
            primaryButton("Start Using CAESURA-ISLAND", action: complete)
        }
    }

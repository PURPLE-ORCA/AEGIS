...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func setupDirectories() {
        ...
        let dirs = [
            home.appendingPathComponent(".caesura-island/bin"),
            home.appendingPathComponent(".caesura-island/run"),
            home.appendingPathComponent(".caesura-island/cache"),
            home.appendingPathComponent(".caesura-island/sound-packs"),
        ]
        for dir in dirs {
            try? FileManager.default.createDirectory(at: dir, withIntermediateDirectories: true)
        }
        // Write PID
        let pidFile = home.appendingPathComponent(".caesura-island/run/caesura-island.pid")

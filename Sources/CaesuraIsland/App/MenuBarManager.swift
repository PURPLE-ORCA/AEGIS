...
extension Notification.Name {
    static let openSettings = Notification.Name("CaesuraIsland.openSettings")
}
...
final class MenuBarManager: NSObject, NSMenuDelegate {
    ...
    private func setupStatusItem() {
        ...
        if let button = statusItem?.button {
            button.image = NSImage(systemSymbolName: "terminal.fill", accessibilityDescription: "CAESURA-ISLAND")
        ...
        let titleItem = NSMenuItem(title: "CAESURA-ISLAND v\(version)", action: nil, keyEquivalent: "")
        ...
        let quitItem = NSMenuItem(title: "Quit CAESURA-ISLAND", action: #selector(quit), keyEquivalent: "q")
    ...
    @objc private func openSettings() {
        ...
        window.title = "CAESURA-ISLAND Settings"
        window.center()

import Foundation
import XCTest
@testable import CaesuraIslandBridgeSupport
...
final class ReverseJSONLReaderTests: XCTestCase {
    ...
    func testNearEndMatchInLargeFileReadsLessThanFourChunks() throws {
        let transcript = FileManager.default.temporaryDirectory
            .appendingPathComponent("caesura-large-jsonl-\(UUID().uuidString)")
    ...
    private func makeTranscript(data: Data) throws -> URL {
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("caesura-reverse-jsonl-\(UUID().uuidString)")
